...
class course(models.Model):
    ...
    def __str__(self):
        return self.name+" "+self.program_year
...
class ta(models.Model):
    ...
    ratings = models.FloatField(default=0,null=False)
...
class preferences(models.Model):
    facultyID = models.ForeignKey(faculty,on_delete=models.CASCADE, null="False")
    TAID = models.ForeignKey(ta, on_delete=models.CASCADE)
    preference = models.IntegerField(default=0,null=False)         