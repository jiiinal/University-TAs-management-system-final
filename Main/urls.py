...
urlpatterns = [
    ...
    path('updatecourse/<str:id>/',update_course,name='updatecourse'),
    path('deletestudent/<str:pk>/',delete_student,name='deletestudent'),
    path('deletecourse/<str:id>/',delete_course,name='deletecourse'),
    ...
    path('student/<str:id>', studentHome, name='studentHome'),
    path('student/selectCourse/<str:id>', rateTA, name='rateTA'),
    path('student/selectTA/<str:id>', rateTA2, name='rateTA2'),
